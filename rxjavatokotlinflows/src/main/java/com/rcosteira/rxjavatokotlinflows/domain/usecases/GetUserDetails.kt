...
class GetUserDetails @Inject constructor(private val repository: Repository) : UseCase<DetailedUser, Username>() {
    override suspend fun run(params: Username): Either<Failure, DetailedUser> = repository.getUserDetails(params)
}
